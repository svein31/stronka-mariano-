...
const OrderConfirmation=lazy(()=>import('./routes/Checkout').then(m=>({default:m.OrderConfirmation})))
const Tracking=lazy(()=>import('./routes/Workshop').then(m=>({default:m.Tracking})))
const Personalization=lazy(()=>import('./routes/Workshop').then(m=>({default:m.Personalization})))
const NewsletterAction=lazy(()=>import('./routes/Workshop').then(m=>({default:m.NewsletterAction})))
const Admin=lazy(()=>import('./routes/Admin').then(m=>({default:m.Admin})))
const PersonalizationStart=lazy(()=>import('./routes/PersonalizationStart').then(m=>({default:m.PersonalizationStart})))
import {ConnectionStatus} from './components/ConnectionStatus'
export function App() {
 return <><div id="site-content"><Nav/><main id="main-content"><ConnectionStatus/><RouteBoundary><Routes>
